...
// 			  emailChar	 = document.getElementsByTagName('input')[0].toString().indexOf('@'),
// 			  emailDot   = document.getElementsByTagName('input')[0].toString().indexOf('.');
...
// 			alert(11)
// 			userName.after('<span class="form-warm">请输入用户名</span>');
// 			e.preventDefault();
// 		}
// 		/*　密码输入为空　*/
// 		if (!password.val()) {
